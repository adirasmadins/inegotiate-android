...
public class GetTopicAttributesResultStaxUnmarshaller implements Unmarshaller<GetTopicAttributesResult, StaxUnmarshallerContext> {
    ...
    public GetTopicAttributesResult unmarshall(StaxUnmarshallerContext staxUnmarshallerContext) throws Exception {
        ...
        while (true) {
            ...
            if (nextEvent.isAttribute() || nextEvent.isStartElement()) {
                if (staxUnmarshallerContext.testExpression("Attributes/entry", i)) {
                    ...
                    getTopicAttributesResult.getAttributes().put(unmarshall.getKey(), unmarshall.getValue());
                }
