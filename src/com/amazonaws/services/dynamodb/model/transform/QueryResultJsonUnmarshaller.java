    ...
    public QueryResult unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
        ...
        while (jsonToken != null) {
            ...
            if (jsonUnmarshallerContext.testExpression("Items", i)) {
                queryResult.setItems(new ListUnmarshaller(new MapUnmarshaller(StringJsonUnmarshaller.getInstance(), AttributeValueJsonUnmarshaller.getInstance())).unmarshall(jsonUnmarshallerContext));
            }
            if (jsonUnmarshallerContext.testExpression("Count", i)) {
                jsonUnmarshallerContext.nextToken();
                queryResult.setCount(IntegerJsonUnmarshaller.getInstance().unmarshall(jsonUnmarshallerContext));
            }
            if (jsonUnmarshallerContext.testExpression("LastEvaluatedKey", i)) {
                jsonUnmarshallerContext.nextToken();
                queryResult.setLastEvaluatedKey(KeyJsonUnmarshaller.getInstance().unmarshall(jsonUnmarshallerContext));
            }
            if (jsonUnmarshallerContext.testExpression("ConsumedCapacityUnits", i)) {
                jsonUnmarshallerContext.nextToken();
                queryResult.setConsumedCapacityUnits(DoubleJsonUnmarshaller.getInstance().unmarshall(jsonUnmarshallerContext));
            }
            jsonToken = jsonUnmarshallerContext.nextToken();
        }
        return queryResult;
