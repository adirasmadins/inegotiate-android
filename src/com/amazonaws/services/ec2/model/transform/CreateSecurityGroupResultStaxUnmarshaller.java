...
public class CreateSecurityGroupResultStaxUnmarshaller implements Unmarshaller<CreateSecurityGroupResult, StaxUnmarshallerContext> {
    ...
    public CreateSecurityGroupResult unmarshall(StaxUnmarshallerContext staxUnmarshallerContext) throws Exception {
        ...
        while (true) {
            ...
            if (nextEvent.isAttribute() || nextEvent.isStartElement()) {
                if (staxUnmarshallerContext.testExpression("groupId", i)) {
                    createSecurityGroupResult.setGroupId(StringStaxUnmarshaller.getInstance().unmarshall(staxUnmarshallerContext));
                }
