...
public class JSONArray {
        ...
        if (jSONTokener.nextClean() != ']') {
            ...
            while (true) {
                ...
                switch (nextClean2) {
                    case ')':
                    case ']':
                        if (nextClean != nextClean2) {
                            throw jSONTokener.syntaxError("Expected a '" + new Character(nextClean) + "'");
                        }
                        return;
                    case ',':
                    case ';':
    ...
    public String optString(int i) {
        return optString(i, StringUtil.EMPTY_STRING);
    }
    ...
    String toString(int i, int i2) throws JSONException {
        ...
        if (length == 1) {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                ...
                stringBuffer.append(JSONObject.valueToString(this.myArrayList.get(i5), i, i4));
            }
            stringBuffer.append('\n');
            while (i3 < i2) {
                stringBuffer.append(' ');
