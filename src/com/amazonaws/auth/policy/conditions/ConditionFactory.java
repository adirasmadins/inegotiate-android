...
public class ConditionFactory {
    ...
    public static Condition newRefererCondition(StringComparisonType stringComparisonType, String str) {
    ...
    public static Condition newSourceArnCondition(String str) {
        return new ArnCondition(ArnComparisonType.ArnLike, SOURCE_ARN_CONDITION_KEY, str);
    }

    public static Condition newUserAgentCondition(StringComparisonType stringComparisonType, String str) {
