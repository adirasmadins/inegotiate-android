...
final class Synchronized {
    ...
    private static class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Entry<K, Collection<V>>> {
        ...
        class C06371 extends ForwardingIterator<Entry<K, Collection<V>>> {
            final /* synthetic */ Iterator val$iterator;

            /* renamed from: com.google.common.collect.Synchronized.SynchronizedAsMapEntries.1.1 */
            class C06361 extends ForwardingMapEntry<K, Collection<V>> {
            ...
            public Entry<K, Collection<V>> next() {
                return new C06361((Entry) this.val$iterator.next());
            }
        }
        ...
        public Iterator<Entry<K, Collection<V>>> iterator() {
            return new C06371(super.iterator());
        }
    ...
    private static class SynchronizedAsMapValues<V> extends SynchronizedCollection<Collection<V>> {
        ...
        class C06381 extends ForwardingIterator<Collection<V>> {
            final /* synthetic */ Iterator val$iterator;
            ...
            public Collection<V> next() {
                return Synchronized.typePreservingCollection((Collection) this.val$iterator.next(), SynchronizedAsMapValues.this.mutex);
            }
        }
        ...
        public Iterator<Collection<V>> iterator() {
            return new C06381(super.iterator());
        }
    }
