...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    class C06451 implements Function<Map<C, V>, Iterator<C>> {
        C06451() {
        }
    ...
    class C06462 extends AbstractIterator<C> {
        C lastValue;
        final /* synthetic */ Comparator val$comparator;
        final /* synthetic */ Iterator val$merged;

        C06462(Iterator it, Comparator comparator) {
            this.val$merged = it;
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        return new C06462(Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new C06451()), comparator), comparator);
    }
}
