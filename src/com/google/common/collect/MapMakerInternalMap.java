...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
                ...
                for (int oldIndex = 0; oldIndex < oldCapacity; oldIndex++) {
                    ...
                    if (head != null) {
                        ...
                        if (next == null) {
                            ...
                            for (ReferenceEntry e2 = head; e2 != tail; e2 = e2.getNext()) {
                                if (isCollected(e2)) {
                                    removeCollectedEntry(e2);
                                    newCount--;
                                } else {
                                    newIndex = e2.getHash() & newMask;
                                    newTable.set(newIndex, copyEntry(e2, (ReferenceEntry) newTable.get(newIndex)));
                                }
                            }
                        }
                    }
    ...
    static abstract class AbstractSerializationProxy<K, V> extends ForwardingConcurrentMap<K, V> implements Serializable {
        ...
        MapMaker readMapMaker(ObjectInputStream in) throws IOException {
            MapMaker mapMaker = new MapMaker().initialCapacity(in.readInt()).setKeyStrength(this.keyStrength).setValueStrength(this.valueStrength).keyEquivalence(this.keyEquivalence).valueEquivalence(this.valueEquivalence).concurrencyLevel(this.concurrencyLevel);
    ...
    static class C05141 implements ValueReference<Object, Object> {
        C05141() {
        }
    ...
    static class C05152 extends AbstractQueue<Object> {
        C05152() {
        }
    ...
    enum EntryFactory {
        ...
        static {
            ...
            entryFactoryArr[EXPIRABLE_MASK] = new EntryFactory[]{SOFT, SOFT_EXPIRABLE, SOFT_EVICTABLE, SOFT_EXPIRABLE_EVICTABLE};
    ...
    static final class EvictionQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C05251 extends AbstractReferenceEntry<K, V> {
        ...
        class C05262 extends AbstractLinkedIterator<ReferenceEntry<K, V>> {
            C05262(ReferenceEntry x0) {
                super(x0);
            }
    ...
    static final class ExpirationQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C05271 extends AbstractReferenceEntry<K, V> {
        ...
        class C05282 extends AbstractLinkedIterator<ReferenceEntry<K, V>> {
            C05282(ReferenceEntry x0) {
                super(x0);
            }
