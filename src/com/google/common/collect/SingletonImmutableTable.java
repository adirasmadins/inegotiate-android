...
final class SingletonImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public V get(@Nullable Object rowKey, @Nullable Object columnKey) {
        return contains(rowKey, columnKey) ? this.singleValue : null;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Table) {
            ...
            if (that.size() == 1) {
                Cell<?, ?, ?> thatCell = (Cell) that.cellSet().iterator().next();
    ...
    public String toString() {
        return Category.SCHEME_PREFIX + this.singleRowKey + "={" + this.singleColumnKey + '=' + this.singleValue + "}}";
    }
}
