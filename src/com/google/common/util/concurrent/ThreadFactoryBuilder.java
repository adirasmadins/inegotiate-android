...
public final class ThreadFactoryBuilder {
    ...
    static class C07111 implements ThreadFactory {
        ...
        C07111(ThreadFactory threadFactory, String str, AtomicLong atomicLong, Boolean bool, Integer num, UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private static ThreadFactory build(ThreadFactoryBuilder builder) {
        ...
        return new C07111(builder.backingThreadFactory != null ? builder.backingThreadFactory : Executors.defaultThreadFactory(), nameFormat, nameFormat != null ? new AtomicLong(0) : null, builder.daemon, builder.priority, builder.uncaughtExceptionHandler);
    }
}
