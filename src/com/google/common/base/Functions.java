...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        private static final long serialVersionUID = 0;
        private final Function<A, ? extends B> f430f;
        private final Function<B, C> f431g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f431g = (Function) Preconditions.checkNotNull(g);
            this.f430f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(A a) {
            return this.f431g.apply(this.f430f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f430f.equals(that.f430f) && this.f431g.equals(that.f431g)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return this.f430f.hashCode() ^ this.f431g.hashCode();
        }

        public String toString() {
            return this.f431g.toString() + "(" + this.f430f.toString() + ")";
        }
    }
