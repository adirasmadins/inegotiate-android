...
public final class Predicates {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        private static final long serialVersionUID = 0;
        final Function<A, ? extends B> f432f;
        final Predicate<B> f433p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f433p = (Predicate) Preconditions.checkNotNull(p);
            this.f432f = (Function) Preconditions.checkNotNull(f);
        }

        public boolean apply(A a) {
            return this.f433p.apply(this.f432f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f432f.equals(that.f432f) && this.f433p.equals(that.f433p)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return this.f432f.hashCode() ^ this.f433p.hashCode();
        }

        public String toString() {
            return this.f433p.toString() + "(" + this.f432f.toString() + ")";
        }
    }
