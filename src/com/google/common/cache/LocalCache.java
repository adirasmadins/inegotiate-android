...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class C03731 implements ValueReference<Object, Object> {
        C03731() {
        }
    ...
    static class C03742 extends AbstractQueue<Object> {
        C03742() {
        }
    ...
    static final class AccessQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C03751 extends AbstractReferenceEntry<K, V> {
        ...
        class C03762 extends AbstractLinkedIterator<ReferenceEntry<K, V>> {
            C03762(ReferenceEntry x0) {
                super(x0);
            }
    ...
    enum EntryFactory {
        ...
        static EntryFactory getFactory(Strength keyStrength, boolean usesAccessQueue, boolean usesWriteQueue) {
            ...
            int i3 = (usesAccessQueue ? ACCESS_MASK : 0) | i;
            if (usesWriteQueue) {
                i2 = WRITE_MASK;
            }
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
            ...
            if (previousValue == null) {
                ...
                if (newValue2 == null) {
                    newValue2 = Futures.immediateFuture(null);
                }
                return newValue2;
            }
        }
    ...
    static class LocalManualCache<K, V> implements Cache<K, V>, Serializable {
        ...
        class C03851 extends CacheLoader<Object, V> {
            final /* synthetic */ Callable val$valueLoader;

            C03851(Callable callable) {
        ...
        protected LocalManualCache(CacheBuilder<? super K, ? super V> builder, CacheLoader<? super K, V> loader) {
            this.localCache = new LocalCache(builder, loader);
        }
        ...
        public V get(K key, Callable<? extends V> valueLoader) throws ExecutionException {
            ...
            return this.localCache.get(key, new C03851(valueLoader));
        }
    ...
    static class LocalLoadingCache<K, V> extends LocalManualCache<K, V> implements LoadingCache<K, V> {
        ...
        LocalLoadingCache(CacheBuilder<? super K, ? super V> builder, CacheLoader<? super K, V> loader) {
            super(builder, (CacheLoader) Preconditions.checkNotNull(loader));
        }
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        class C03861 implements Runnable {
            ...
            C03861(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
                this.val$key = obj;
                this.val$hash = i;
            ...
            public void run() {
                try {
                    this.val$loadingValueReference.set(Segment.this.getAndRecordStats(this.val$key, this.val$hash, this.val$loadingValueReference, this.val$loadingFuture));
                } catch (Throwable t) {
        ...
        void initTable(AtomicReferenceArray<ReferenceEntry<K, V>> newTable) {
            this.threshold = (newTable.length() * LocalCache.CONTAINS_VALUE_RETRIES) / 4;
        ...
        ListenableFuture<V> loadAsync(K key, int hash, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader) {
            ...
            loadingFuture.addListener(new C03861(key, hash, loadingValueReference, loadingFuture), LocalCache.sameThreadExecutor);
        ...
        @Nullable
        LoadingValueReference<K, V> insertLoadingValueReference(K key, int hash) {
            lock();
            try {
                        ...
                        if (next == null) {
                            ...
                            for (e = head; e != tail; e = e.getNext()) {
                                if (isCollected(e)) {
                                    ...
                                    newIndex = e.getHash() & newMask;
                                    newTable.set(newIndex, copyEntry(e, (ReferenceEntry) newTable.get(newIndex)));
                                }
                            }
                        }
                    }
    ...
    static final class WeightedSoftValueReference<K, V> extends SoftValueReference<K, V> {
        ...
        public ValueReference<K, V> copyFor(ReferenceQueue<V> queue, ReferenceEntry<K, V> entry) {
            return new WeightedSoftValueReference(queue, get(), entry, this.weight);
        }
    }
    ...
    static final class WeightedWeakValueReference<K, V> extends WeakValueReference<K, V> {
        ...
        public ValueReference<K, V> copyFor(ReferenceQueue<V> queue, ReferenceEntry<K, V> entry) {
            return new WeightedWeakValueReference(queue, get(), entry, this.weight);
        }
    }
    ...
    static final class WriteQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C03901 extends AbstractReferenceEntry<K, V> {
            ReferenceEntry<K, V> nextWrite;
            ReferenceEntry<K, V> previousWrite;
        ...
        class C03912 extends AbstractLinkedIterator<ReferenceEntry<K, V>> {
            C03912(ReferenceEntry x0) {
                super(x0);
            }
    ...
    LocalCache(CacheBuilder<? super K, ? super V> builder, CacheLoader<? super K, V> loader) {
        ...
        int segmentShift = 0;
        int segmentCount = 1;
        while (segmentCount < this.concurrencyLevel && (!evictsBySize() || customWeigher() || ((long) (segmentCount * 2)) <= this.maxWeight)) {
            segmentShift++;
            segmentCount <<= 1;
        }
