...
public final class CacheBuilder<K, V> {
    ...
    static class C03701 implements StatsCounter {
        C03701() {
        }
    ...
    static class C03712 implements Supplier<SimpleStatsCounter> {
        C03712() {
        }
    ...
    static class C03723 extends Ticker {
        C03723() {
        }
    ...
    static {
        NULL_STATS_COUNTER = Suppliers.ofInstance(new C03701());
        EMPTY_STATS = new CacheStats(0, 0, 0, 0, 0, 0);
        CACHE_STATS_COUNTER = new C03712();
        NULL_TICKER = new C03723();
    ...
    CacheBuilder<K, V> disableStats() {
        Preconditions.checkState(this.statsCounterSupplier == CACHE_STATS_COUNTER);
