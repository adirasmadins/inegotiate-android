...
public final class CodedOutputStream {
    ...
    public void writeStringNoTag(String value) throws IOException {
        byte[] bytes = value.getBytes(StringEncodings.UTF8);
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & -128) != 0) {
            writeRawByte((value & Ascii.MAX) | XMLChar.MASK_NCNAME);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while ((-128 & value) != 0) {
            writeRawByte((((int) value) & Ascii.MAX) | XMLChar.MASK_NCNAME);
            value >>>= 7;
        }
    ...
    public void writeRawLittleEndian32(int value) throws IOException {
        ...
        writeRawByte((value >> LITTLE_ENDIAN_64_SIZE) & 255);
    ...
    public void writeRawLittleEndian64(long value) throws IOException {
        ...
        writeRawByte(((int) (value >> LITTLE_ENDIAN_64_SIZE)) & 255);
