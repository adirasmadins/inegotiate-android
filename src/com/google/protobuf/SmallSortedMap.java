...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    static class C08541 extends SmallSortedMap<FieldDescriptorType, Object> {
        C08541(int x0) {
            super(null);
        }
    ...
    private static class EmptySet {
        ...
        static class C08551 implements Iterator<Object> {
            C08551() {
            }
        ...
        static class C08562 implements Iterable<Object> {
            C08562() {
            }
