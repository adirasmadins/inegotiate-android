...
@Default(localName = "archiveNotifyStatus", nsAlias = "docs", nsUri = "http://schemas.google.com/docs/2007")
public class ArchiveNotifyStatus extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean required, boolean repeatable) {
        ExtensionDescription desc = ExtensionDescription.getDefaultDescription(ArchiveNotifyStatus.class);
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractExtension.eq(this.value, ((ArchiveNotifyStatus) obj).value);
    }
