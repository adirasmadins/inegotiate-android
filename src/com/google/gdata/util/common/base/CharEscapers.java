...
public final class CharEscapers {
    ...
    /* renamed from: com.google.gdata.util.common.base.CharEscapers.1 */
    static class C07501 extends CharEscaper {

        /* renamed from: com.google.gdata.util.common.base.CharEscapers.1.1 */
        class C07491 implements Appendable {
            final /* synthetic */ Appendable val$out;

            public Appendable append(CharSequence csq) throws IOException {
                Preconditions.checkNotNull(csq);
                this.val$out.append(csq);
                return this;
            }

            public Appendable append(CharSequence csq, int start, int end) throws IOException {
                Preconditions.checkNotNull(csq);
                this.val$out.append(csq, start, end);
                return this;
            }

            C07491(Appendable appendable) throws IOException {
        ...
        public Appendable escape(Appendable out) {
            ...
            return new C07491(out);
        }

        C07501() throws IOException {
        }
    ...
    /* renamed from: com.google.gdata.util.common.base.CharEscapers.2 */
    static class C07512 extends CharEscaper {
        C07512() {
        }
        ...
        protected char[] escape(char c) {
            ...
            char[] r = new char[6];
            r[5] = CharEscapers.HEX_DIGITS[c & 15];
            c = (char) (c >>> 4);
            r[4] = CharEscapers.HEX_DIGITS[c & 15];
            c = (char) (c >>> 4);
            r[3] = CharEscapers.HEX_DIGITS[c & 15];
            r[2] = CharEscapers.HEX_DIGITS[((char) (c >>> 4)) & 15];
            r[1] = 'u';
            r[0] = '\\';
            return r;
        }
    ...
    private static class FallThroughCharEscaper extends CharEscaper {
        ...
        protected char[] escape(char c) {
            ...
            if (result == null) {
                return this.secondary.escape(c);
            }
            return result;
        }
    }
    ...
    private static abstract class FastCharEscaper extends CharEscaper {
        ...
        public String escape(String s) {
            ...
            for (int index = 0; index < slen; index++) {
                ...
                if ((c < this.replacementLength && this.replacements[c] != null) || c < this.safeMin || c > this.safeMax) {
    ...
    private static class HtmlCharEscaper extends FastCharEscaper {
        ...
        protected char[] escape(char c) {
            if (c < this.replacementLength) {
                char[] r = this.replacements[c];
                if (r != null) {
                    return r;
                }
            }
            ...
            int intValue = c;
            while (index > 1) {
                result[index] = CharEscapers.HEX_DIGITS[intValue % 10];
                intValue /= 10;
                index--;
            }
            return result;
    ...
    private static class JavaCharEscaper extends FastCharEscaper {
        ...
        protected char[] escape(char c) {
            ...
            if (c <= '\u00ff') {
                r = new char[4];
                c = (char) (c >>> 3);
                r[2] = CharEscapers.HEX_DIGITS[c & 7];
                r[1] = CharEscapers.HEX_DIGITS[((char) (c >>> 3)) & 7];
                return r;
            }
            r = new char[6];
            r[0] = '\\';
    ...
    static {
        NULL_ESCAPER = new C07501();
        XML_ESCAPER = newBasicXmlEscapeBuilder().addEscape('\"', "&quot;").addEscape('\'', "&apos;").toEscaper();
        XML_CONTENT_ESCAPER = newBasicXmlEscapeBuilder().toEscaper();
        ASCII_HTML_ESCAPER = new CharEscaperBuilder().addEscape('\"', "&quot;").addEscape('\'', "&#39;").addEscape('&', "&amp;").addEscape(XMLStreamWriterImpl.OPEN_START_TAG, "&lt;").addEscape(XMLStreamWriterImpl.CLOSE_START_TAG, "&gt;").toEscaper();
        URI_ESCAPER = new PercentEscaper(PercentEscaper.SAFECHARS_URLENCODER, true);
        URI_ESCAPER_NO_PLUS = new PercentEscaper(PercentEscaper.SAFECHARS_URLENCODER, false);
        ...
        JAVA_STRING_UNICODE_ESCAPER = new C07512();
        PYTHON_ESCAPER = new CharEscaperBuilder().addEscape('\n', "\\n").addEscape('\r', "\\r").addEscape('\t', "\\t").addEscape('\\', "\\\\").addEscape('\"', "\\\"").addEscape('\'', "\\'").toEscaper();
        JAVASCRIPT_ESCAPER = new JavascriptCharEscaper(new CharEscaperBuilder().addEscape('\'', "\\x27").addEscape('\"', "\\x22").addEscape(XMLStreamWriterImpl.OPEN_START_TAG, "\\x3c").addEscape('=', "\\x3d").addEscape(XMLStreamWriterImpl.CLOSE_START_TAG, "\\x3e").addEscape('&', "\\x26").addEscape('\b', "\\b").addEscape('\t', "\\t").addEscape('\n', "\\n").addEscape('\f', "\\f").addEscape('\r', "\\r").addEscape('\\', "\\\\").toArray());
    ...
    private static CharEscaperBuilder newBasicXmlEscapeBuilder() {
        return new CharEscaperBuilder().addEscape('&', "&amp;").addEscape(XMLStreamWriterImpl.OPEN_START_TAG, "&lt;").addEscape(XMLStreamWriterImpl.CLOSE_START_TAG, "&gt;").addEscapes(new char[]{'\u0000', '\u0001', '\u0002', '\u0003', '\u0004', '\u0005', '\u0006', '\u0007', '\b', '\u000b', '\f', '\u000e', '\u000f', '\u0010', '\u0011', '\u0012', '\u0013', '\u0014', '\u0015', '\u0016', '\u0017', '\u0018', '\u0019', '\u001a', '\u001b', '\u001c', '\u001d', '\u001e', '\u001f'}, StringUtil.EMPTY_STRING);
    }
