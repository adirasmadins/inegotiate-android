...
public final class Characters {
    ...
    /* renamed from: com.google.gdata.util.common.io.Characters.1 */
    static class C07721 implements InputSupplier<StringReader> {
    ...
    /* renamed from: com.google.gdata.util.common.io.Characters.2 */
    static class C07732 implements InputSupplier<InputStreamReader> {
        final /* synthetic */ Charset val$charset;
        final /* synthetic */ InputSupplier val$in;

        C07732(InputSupplier inputSupplier, Charset charset) throws IOException {
    ...
    /* renamed from: com.google.gdata.util.common.io.Characters.3 */
    static class C07743 implements OutputSupplier<OutputStreamWriter> {
        final /* synthetic */ Charset val$charset;
        final /* synthetic */ OutputSupplier val$out;

        C07743(OutputSupplier outputSupplier, Charset charset) throws IOException {
    ...
    /* renamed from: com.google.gdata.util.common.io.Characters.4 */
    static class C07754 implements InputSupplier<Reader> {
        final /* synthetic */ Iterable val$suppliers;

        C07754(Iterable iterable) throws IOException {
