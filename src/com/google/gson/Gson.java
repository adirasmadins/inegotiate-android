...
public final class Gson {
    ...
    class C07901 extends ThreadLocal<Map<TypeToken<?>, FutureTypeAdapter<?>>> {
        C07901() {
        }
    ...
    class C07912 implements JsonDeserializationContext {
        C07912() {
        }
    ...
    class C07923 implements JsonSerializationContext {
        C07923() {
        }
    ...
    class C07934 extends TypeAdapter<Number> {
        C07934() {
        }
    ...
    class C07945 extends TypeAdapter<Number> {
        C07945() {
        }
    ...
    class C07956 extends TypeAdapter<Number> {
        C07956() {
        }
    ...
    static class C07967 extends GsonInternalAccess {
        C07967() {
        }

        public <T> TypeAdapter<T> getNextAdapter(Gson gson, TypeAdapterFactory skipPast, TypeToken<T> type) {
            boolean skipPastFound = Gson.DEFAULT_JSON_NON_EXECUTABLE;
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingPolicy, Map<Type, InstanceCreator<?>> instanceCreators, boolean serializeNulls, boolean complexMapKeySerialization, boolean generateNonExecutableGson, boolean htmlSafe, boolean prettyPrinting, boolean serializeSpecialFloatingPointValues, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> typeAdapterFactories) {
        this.calls = new C07901();
        this.typeTokenCache = Collections.synchronizedMap(new HashMap());
        this.deserializationContext = new C07912();
        this.serializationContext = new C07923();
    ...
    static {
        GsonInternalAccess.INSTANCE = new C07967();
    }
