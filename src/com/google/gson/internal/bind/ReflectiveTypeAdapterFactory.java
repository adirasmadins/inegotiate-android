...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    class C08211 extends BoundField {
        ...
        C08211(String x0, boolean x1, boolean x2, Gson gson, TypeToken typeToken, Field field, boolean z) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        if (Object.class.isAssignableFrom(raw)) {
            return new Adapter(this.constructorConstructor.getConstructor(type), getBoundFields(gson, type, raw), null);
        }
        return null;
    }
    ...
    private BoundField createBoundField(Gson context, Field field, String name, TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        return new C08211(name, serialize, deserialize, context, fieldType, field, Primitives.isPrimitive(fieldType.getRawType()));
    }
