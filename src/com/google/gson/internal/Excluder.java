...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class C08091 extends TypeAdapter<T> {
        ...
        C08091(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
        ...
        private TypeAdapter<T> delegate() {
            ...
            d = GsonInternalAccess.INSTANCE.getNextAdapter(this.val$gson, Excluder.this, this.val$type);
            this.delegate = d;
            return d;
        }
    }
...
*/
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        if (skipSerialize || skipDeserialize) {
            return new C08091(skipDeserialize, skipSerialize, gson, type);
        }
        return null;
    }
