...
public class JsonReader implements Closeable {
    ...
    static class C08341 extends JsonReaderInternalAccess {
        C08341() {
        }
    ...
    static {
        NON_EXECUTE_PREFIX = ")]}'\n".toCharArray();
        JsonReaderInternalAccess.INSTANCE = new C08341();
    }

    public JsonReader(Reader in) {
        this.stringPool = new StringPool();
        this.lenient = false;
        this.buffer = new char[ProgressEvent.PART_STARTED_EVENT_CODE];
        this.pos = 0;
        this.limit = 0;
    ...
    public JsonToken peek() throws IOException {
        ...
        switch (C08352.$SwitchMap$com$google$gson$stream$JsonScope[this.stack[this.stackSize - 1].ordinal()]) {
    ...
    private JsonToken nextInArray(boolean firstElement) throws IOException {
        ...
        checkLenient();
        this.pos--;
        this.value = Constants.NULL_VERSION_ID;
    ...
    private JsonToken objectValue() throws IOException {
        switch (nextNonWhitespace(true)) {
            ...
            case 61:
                checkLenient();
                if ((this.pos < this.limit || fillBuffer(1)) && this.buffer[this.pos] == XMLStreamWriterImpl.CLOSE_START_TAG) {
                    this.pos++;
                    break;
                }
            default:
